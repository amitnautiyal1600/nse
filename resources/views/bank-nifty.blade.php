...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row p-2" style="background:#faf3cd">
            <div class="col-md-4"> 
                <span> Bank Nifty Index <span class="dynamic_data_red nifty_index_value">0</span></span>
            </div>
            <div class="col-md-4"> 
                ...
                <table id="nse_data_table" class="table table-sm table-bordered display compact stripe">
                    <thead>
                        <tr>
                            ...
                            <th colspan="" style="background: darkred; color: white;text-align: center;">BANK N</th>
